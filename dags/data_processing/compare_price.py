...
line_matching_df = line_processed_df.join(
    line_base_names_to_join.unique(subset=["product_name"], keep="first", maintain_order=False),  # Use unique base product_names, includes product_no
    on="product_name",
    how="inner"
)
...
watson_matching_df = watson_processed_df.join(
    watson_base_names_to_join.unique(subset=["product_name"], keep="first", maintain_order=False), # Use unique base product_names, includes product_no
    on="product_name",
    how="inner"
)
